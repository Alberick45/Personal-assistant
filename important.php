...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['file']['name']) && !empty($_FILES['file']['name'])) {
        ...
        $query = "INSERT INTO tasks (task_name, deadline, task_duration, task_description,task_status,task_assigner,task_importance) 
              VALUES (?, ?, ?, ?,'PENDING',?,'Important')";
...
$user_id = $_SESSION['user_id'];
 ...
 // for completed  tasks 
 $query = "SELECT * FROM tasks WHERE task_status = 'COMPLETED' AND task_importance = 'Important' AND (task_assigner = $user_id OR task_assignee = $user_id)";
...
// for important tasks 
$query = "SELECT * FROM tasks WHERE task_status = 'PENDING' AND task_importance = 'Important' AND (task_assigner = $user_id OR task_assignee = $user_id)";

$resultsimportant_tasks= $conn->query($query);
